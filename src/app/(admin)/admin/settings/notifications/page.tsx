  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-[var(--text-muted)] mt-1">Configure email and push notification settings.</p>
      </div>
      <div className="p-10 rounded-2xl border border-dashed border-[var(--border-default)] text-center text-[var(--text-muted)]">
        ...
        <p className="text-xs mt-1 opacity-60">Notification settings will be available in a future update.</p>
      </div>
    </div>
  );
}
